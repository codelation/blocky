module Blocky
  class InstallGenerator < Rails::Generators::Base
    ...
    def ask_questions
      @blocky_route = ask("What route should be used to access the content blocks? [/admin/content]")
...
INITIALIZER
  ...
  #
  # We ask that you don't use the :as option here, as Blocky relies on it being the default of "blocky"
